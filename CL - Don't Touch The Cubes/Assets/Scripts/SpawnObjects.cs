...
public class SpawnObjects : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        while (spawn > 0)
        {
            ...
            Quaternion qRotion = Quaternion.Euler(0, Random.value * 360f, Random.value * 30f);
            GameObject createObject = Instantiate(spawnCube, v3Pos, qRotion);
        }
    }
}
